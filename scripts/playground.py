...
# Items with a hash after are mythics
item_id_name = {
    "": "None",
    "0": "None",
    "1001": "Boots",
...
# Im going to want something like
# UPDATE 'matches'
# SET 'mythic' = :id WHERE :ornn_or_mythic IN (item0, item1, item2, item3, item4, item5, item6)
...
WHERE
    ...
    for key, value in mythics.items():
        print("Currently on", item_id_name[key])
...
def print_mythics():
    for key, value in mythics.items():
        print(item_id_name[key], ":", item_id_name[value])
